...
const Logo: React.FC<Props> = ({ dark, center, size, to = '/' }) => {
  return (
    <Link href={to}>
      <a className={`flex items-center gap-4 ${center ? 'justify-center' : ''}`}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          xmlnsXlink="http://www.w3.org/1999/xlink"
          width={size === 'sm' ? 172 : size === 'md' ? 330 : 445}
          height={size === 'sm' ? 24 : size === 'md' ? 32 : 48}
          viewBox="0 0 1154.88 166.924"
        >
          <defs>
            <clipPath id="clip-path">
              <path
                id="Path_1"
                data-name="Path 1"
                d="M103.176,0,42.468,68.15H81.635v42.691l62.274-67.5-38.775-3Z"
                fill="#635bff"
              />
            </clipPath>
            <clipPath id="clip-path-2">
              <path
                id="Path_2"
                data-name="Path 2"
                d="M93.189,140.924a85.577,85.577,0,0,1-75.1-44.658L0,116.575a111.421,111.421,0,0,0,186.928-.836l-18.164-20.39a85.569,85.569,0,0,1-75.575,45.575"
                fill="#635bff"
              />
            </clipPath>
          </defs>
              ...
              <g id="Group_2" data-name="Group 2">
                <g id="Group_1" data-name="Group 1" clipPath="url(#clip-path)">
                  <rect
                    ...
                    width="101.441"
                    height="110.841"
                    transform="translate(42.468 0)"
                    fill="#635bff"
                  />
                </g>
              </g>
              <g id="Group_4" data-name="Group 4">
                <g id="Group_3" data-name="Group 3" clipPath="url(#clip-path-2)">
                  <rect
                    id="Rectangle_2"
                    data-name="Rectangle 2"
                    width="186.928"
                    height="71.575"
                    transform="translate(0 95.349)"
                    fill="#635bff"
                  />
                </g>
              </g>
